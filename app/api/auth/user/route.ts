/**
 * @buildpad-origin @buildpad/cli/api-routes/auth-user-route
 * @buildpad-version 1.0.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add api-routes/auth-user-route --overwrite
 *
 * Docs: https://buildpad.dev/components/api-routes/auth-user-route
 */
