/**
 * @buildpad-origin @buildpad/ui-interfaces/rich-text-html
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add rich-text-html --overwrite
 *
 * Docs: https://buildpad.dev/components/rich-text-html
 */
