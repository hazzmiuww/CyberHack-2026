...
/**
 * @buildpad-origin @buildpad/ui-interfaces/collection-item-dropdown
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add collection-item-dropdown --overwrite
 *
 * Docs: https://buildpad.dev/components/collection-item-dropdown
 */
