...
/**
 * @buildpad-origin @buildpad/ui-interfaces/select-dropdown-m2o
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add select-dropdown-m2o --overwrite
 *
 * Docs: https://buildpad.dev/components/select-dropdown-m2o
 */
...
import type { M2ORelationInfo, M2OItem } from '@/lib/buildpad/hooks';
