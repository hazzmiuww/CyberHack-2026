/**
 * @buildpad-origin @buildpad/ui-collections/content-navigation
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add content-navigation --overwrite
 *
 * Docs: https://buildpad.dev/components/content-navigation
 */
...
import type { Collection, Bookmark } from '@/lib/buildpad/types';
 ...
 * @example
 * ```tsx
 * import { ContentNavigation } from '@/components/ui';
