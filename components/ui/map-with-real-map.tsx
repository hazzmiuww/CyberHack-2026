/**
 * @buildpad-origin @buildpad/ui-interfaces/map-with-real-map
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add map-with-real-map --overwrite
 *
 * Docs: https://buildpad.dev/components/map-with-real-map
 */
