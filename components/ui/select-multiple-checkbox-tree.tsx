/**
 * @buildpad-origin @buildpad/ui-interfaces/select-multiple-checkbox-tree
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add select-multiple-checkbox-tree --overwrite
 *
 * Docs: https://buildpad.dev/components/select-multiple-checkbox-tree
 */
