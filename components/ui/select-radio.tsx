...
/**
 * @buildpad-origin @buildpad/ui-interfaces/select-radio
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add select-radio --overwrite
 *
 * Docs: https://buildpad.dev/components/select-radio
 */
