/**
 * @buildpad-origin @buildpad/ui-interfaces/autocomplete-api
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add autocomplete-api --overwrite
 *
 * Docs: https://buildpad.dev/components/autocomplete-api
 */
