/**
 * @buildpad-origin @buildpad/ui-interfaces/rich-text-markdown
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add rich-text-markdown --overwrite
 *
 * Docs: https://buildpad.dev/components/rich-text-markdown
 */
