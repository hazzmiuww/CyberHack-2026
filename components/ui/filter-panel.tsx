/**
 * @buildpad-origin @buildpad/ui-collections/filter-panel
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add filter-panel --overwrite
 *
 * Docs: https://buildpad.dev/components/filter-panel
 */
