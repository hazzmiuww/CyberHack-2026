...
/**
 * @buildpad-origin @buildpad/ui-interfaces/list-o2m
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add list-o2m --overwrite
 *
 * Docs: https://buildpad.dev/components/list-o2m
 */
...
import { CollectionForm, CollectionList } from '@/components/ui';
import {
  IconAlertCircle,
  IconChevronDown,
  IconChevronUp,
...
export const ListO2M: React.FC<ListO2MProps> = ({
  ...
  const handleSelectItems = async (ids: (string | number)[]) => {
    ...
    if (isParentSaved) {
      ...
      try {
        const { apiRequest } = await import('@/lib/buildpad/services');
