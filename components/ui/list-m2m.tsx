...
import { CollectionList, CollectionForm } from '@/components/ui';
import { renderTemplate, resolveDisplayTemplate, DEFAULT_RELATIONAL_FIELDS } from "./list-m2a/render-template";
import { useRelationMultipleM2M, type M2MDisplayItem, type M2MChangesItem } from '@/lib/buildpad/hooks';
import { useRelationPermissionsM2M } from '@/lib/buildpad/hooks';
import { mergeTranslations, interpolate, formatItemCount, type M2MTranslations } from "./list-m2m/translations";
