/**
 * @buildpad-origin @buildpad/ui-collections/content-layout
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add content-layout --overwrite
 *
 * Docs: https://buildpad.dev/components/content-layout
 */
