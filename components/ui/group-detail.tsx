/**
 * @buildpad-origin @buildpad/ui-interfaces/group-detail
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add group-detail --overwrite
 *
 * Docs: https://buildpad.dev/components/group-detail
 */
