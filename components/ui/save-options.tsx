/**
 * @buildpad-origin @buildpad/ui-collections/save-options
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add save-options --overwrite
 *
 * Docs: https://buildpad.dev/components/save-options
 */
