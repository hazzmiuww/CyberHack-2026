/**
 * @buildpad-origin @buildpad/cli/supabase-auth/server
 * @buildpad-version 1.0.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add supabase-auth/server --overwrite
 *
 * Docs: https://buildpad.dev/components/supabase-auth/server
 */
