/**
 * @buildpad-origin @buildpad/cli/supabase-auth/admin
 * @buildpad-version 1.0.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add supabase-auth/admin --overwrite
 *
 * Docs: https://buildpad.dev/components/supabase-auth/admin
 */
