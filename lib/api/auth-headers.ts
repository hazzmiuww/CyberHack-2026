 ...
 * Compatibility alias.
 *
 * Several CLI-generated API route files import `getDaaSUrl` (capital "S"),
 * but the canonical export above is `getDaasUrl`. This alias makes both
 * spellings resolve to the same function so the build doesn't break.
 */
