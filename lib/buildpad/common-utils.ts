/**
 * @buildpad-origin @buildpad/cli/utils/common-utils
 * @buildpad-version 1.0.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add utils/common-utils --overwrite
 *
 * Docs: https://buildpad.dev/components/utils/common-utils
 */
