...
/**
 * @buildpad-origin @buildpad/services/services/daas-context
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add services/daas-context --overwrite
 *
 * Docs: https://buildpad.dev/components/services/daas-context
 */
