/**
 * @buildpad-origin @buildpad/services/services/permissions
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add services/permissions --overwrite
 *
 * Docs: https://buildpad.dev/components/services/permissions
 */
