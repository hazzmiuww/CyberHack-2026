/**
 * @buildpad-origin @buildpad/services/services/filter-to-query
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add services/filter-to-query --overwrite
 *
 * Docs: https://buildpad.dev/components/services/filter-to-query
 */
