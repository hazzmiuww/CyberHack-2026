/**
 * @buildpad-origin @buildpad/services/services/session
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add services/session --overwrite
 *
 * Docs: https://buildpad.dev/components/services/session
 */
 ...
 * import { configureAuth } from '@/lib/buildpad/services/auth';
