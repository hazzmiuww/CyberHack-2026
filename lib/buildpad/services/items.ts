/**
 * @buildpad-origin @buildpad/services/services/items
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add services/items --overwrite
 *
 * Docs: https://buildpad.dev/components/services/items
 */
...
import type { AnyItem, PrimaryKey } from '@/lib/buildpad/types';
