/**
 * @buildpad-origin @buildpad/utils/utils/define-interface
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add utils/define-interface --overwrite
 *
 * Docs: https://buildpad.dev/components/utils/define-interface
 */
 ...
 * @example
 * ```tsx
 * import { defineInterface } from '@/lib/buildpad/utils';
 * 
 ...
 * @example
 * ```tsx
 * import { defineInterfaces } from '@/lib/buildpad/utils';
 * 
