/**
 * @buildpad-origin @buildpad/hooks/hooks/useRelationPermissionsM2A
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useRelationPermissionsM2A --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useRelationPermissionsM2A
 */
