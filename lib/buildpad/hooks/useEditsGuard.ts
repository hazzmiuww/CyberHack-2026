...
/**
 * @buildpad-origin @buildpad/hooks/hooks/useEditsGuard
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useEditsGuard --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useEditsGuard
 */
