/**
 * @buildpad-origin @buildpad/hooks/hooks/useRelationM2MItems
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useRelationM2MItems --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useRelationM2MItems
 */
