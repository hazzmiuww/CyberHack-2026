/**
 * @buildpad-origin @buildpad/hooks/hooks/useRelationMultipleM2M
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useRelationMultipleM2M --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useRelationMultipleM2M
 */
