...
/**
 * @buildpad-origin @buildpad/hooks/hooks/useFiles
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useFiles --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useFiles
 */

import { useState, useCallback } from 'react';
import { buildApiUrl, getApiHeaders, apiRequest } from '@/lib/buildpad/services';
