/**
 * @buildpad-origin @buildpad/hooks/hooks/useFieldMetadata
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add hooks/useFieldMetadata --overwrite
 *
 * Docs: https://buildpad.dev/components/hooks/useFieldMetadata
 */
...
import type { Field, FieldMeta } from '@/lib/buildpad/types';
