/**
 * @buildpad-origin @buildpad/utils/utils/interface-types
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add utils/interface-types --overwrite
 *
 * Docs: https://buildpad.dev/components/utils/interface-types
 */
