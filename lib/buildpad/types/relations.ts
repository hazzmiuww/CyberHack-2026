/**
 * @buildpad-origin @buildpad/types/types/relations
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add types/relations --overwrite
 *
 * Docs: https://buildpad.dev/components/types/relations
 */
