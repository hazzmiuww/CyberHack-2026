/**
 * @buildpad-origin @buildpad/utils/utils/interface-registry
 * @buildpad-version 0.2.0
 *
 * This file was copied from Buildpad UI Packages.
 * To update, run: npx @buildpad/cli add utils/interface-registry --overwrite
 *
 * Docs: https://buildpad.dev/components/utils/interface-registry
 */
